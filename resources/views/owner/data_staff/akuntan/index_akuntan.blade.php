                                                    ...
                                                    @foreach ($akuntan as $d)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                ...
                                                                <div class="btn-group">
                                                                    @if ($d->status_validasi_akuntan == 0)
                                                                        <a href="#" class="validasi_akuntan btn btn-info btn-sm"
                                                                            id="{{ $d->id_akuntan }}">
                                                                    ...
                                                                    @else
                                                                        <form
                                                                            action="/owner/data_staff/akuntan/{{ $d->id_akuntan }}/batalkan_validasi_akuntan"
                                                                            style="margin-left: 5px;" method="POST">
                                                                            @csrf
                                                                            <a
                                                                                class="btn btn-sm bg-danger batalkan_validasi_akuntan">
                                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                                    height="24" viewBox="0 0 24 24" fill="none"
                                                                                    stroke="currentColor" stroke-width="2"
                                                                                    stroke-linecap="round" stroke-linejoin="round"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Validasi Data Akuntan</h5>
    ...
    <script>
        $(function () {
            ...
            $(".validasi_akuntan").click(function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: '/owner/data_staff/akuntan/validasi_akuntan',
                    cache: false,
                    data: {
                        _token: "{{ csrf_token() }}",
                        id: id
