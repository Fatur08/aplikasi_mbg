                                                    ...
                                                    @foreach ($driver as $d)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                ...
                                                                <div class="btn-group">
                                                                    @if ($d->status_validasi_driver == 0)
                                                                        <a href="#" class="validasi_driver btn btn-info btn-sm"
                                                                            id="{{ $d->id_driver }}">
                                                                    ...
                                                                    @else
                                                                        <form
                                                                            action="/owner/data_staff/driver/{{ $d->id_driver }}/batalkan_validasi_driver"
                                                                            style="margin-left: 5px;" method="POST">
                                                                            @csrf
                                                                            <a
                                                                                class="btn btn-sm bg-danger batalkan_validasi_driver">
                                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                                    height="24" viewBox="0 0 24 24" fill="none"
                                                                                    stroke="currentColor" stroke-width="2"
                                                                                    stroke-linecap="round" stroke-linejoin="round"
