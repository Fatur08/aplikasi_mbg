                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mt-2">
                                <form action="/owner/data_staff/maker" method="GET">
                                    <div class="col-12">
                                                    ...
                                                    @foreach ($maker as $d)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                ...
                                                                <div class="btn-group">
                                                                    @if ($d->status_validasi_maker == 0)
                                                                        <a href="#" class="validasi_maker btn btn-info btn-sm"
                                                                            id="{{ $d->id_maker }}">
                                                                    ...
                                                                    @else
                                                                        <form
                                                                            action="/owner/data_staff/maker/{{ $d->id_maker }}/batalkan_validasi_maker"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/owner/data_staff/maker/store_maker" method="POST" id="FormTambahMaker"
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" value="" id="nama_maker" class="form-control" name="nama_maker"
                                        placeholder="Masukkan Nama Lengkap">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="input-icon">
                                    ...
                                    <input type="email" id="email_maker" name="email_maker" class="form-control"
                                        placeholder="Masukkan E-Mail (gmail)" pattern="^[a-zA-Z0-9._%+-]+@gmail\.com$"
                        ...
                        <div class="row mt-3 mb-3">
                            <div class="col-12">
                                <div class="input-icon">
                                    ...
                                    <input type="text" value="" id="alamat_maker" class="form-control" name="alamat_maker"
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="input-icon">
                                    ...
                                    <input type="text" id="no_hp_maker" name="no_hp_maker" class="form-control"
