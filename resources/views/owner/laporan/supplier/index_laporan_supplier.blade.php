                                                ...
                                                <table class="table custom-table">
                                                    <thead class="table-primary text-center">
                                                        <tr>
                                                            ...
                                                            <th style="text-align: center; vertical-align: middle;">Bukti
                                                            </th>
                                                            ...
                                                            ->translatedFormat('d F Y') }}
                                                                                                            ...
                                                                                                            <td style="text-align:center">
                                                                                                                ...
                                                                                                                <div class="btn-group">
                                                                                                                    @if ($item->status_barang_supplier == 0)
                                                                                                                        <a href="#"
                                                                                                                            class="validasi_laporan_supplier btn btn-info btn-sm"
                                                                                                                            id="{{ $item->id_barang_supplier }}">
                                                                                                                    ...
                                                                                                                    @else
                                                                                                                        <form
                                                                                                                            action="/owner/laporan/supplier/{{ $item->id_barang_supplier }}/batalkan_validasi_laporan_supplier"
                                                                                                                            style="margin-left: 5px;" method="POST">
                                                                                                                            @csrf
                                                                                                                            <a
                                                                                                                                class="btn btn-sm bg-danger batalkan_validasi_laporan_supplier">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/owner/laporan/supplier/store_laporan_supplier" method="POST" id="FormLaporansupplier"
