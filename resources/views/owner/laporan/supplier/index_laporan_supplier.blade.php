                                                    ...
                                                    @forelse ($barangSupplier as $key => $item)
                                                        <tr class="text-center">
                                                            ...
                                                            <td style="text-align:center">
                                                                ...
                                                                <div class="btn-group">
                                                                    @if ($item->status_barang_supplier == 0)
                                                                    <a href="#" class="validasi_laporan_supplier btn btn-info btn-sm" id="{{ $item->id_barang_supplier }}" >
                                                                    ...
                                                                    <form action="/owner/laporan/supplier/{{ $item->id_barang_supplier }}/batalkan_validasi_laporan_supplier" style="margin-left: 5px;" method="POST">
                                                                        @csrf  
                                                                        <a class="btn btn-sm bg-danger batalkan_validasi_laporan_supplier">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" value="" id="tanggal_laporan_supplier" name="tanggal_laporan_supplier" class="form-control" placeholder="Masukkan Tanggal" autocomplete="off">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <select name="id_informasi_supplier" id="id_informasi_supplier" class="form-select" required>
...
<!-- VALIDASI LAPORAN SUPPLIER -->
<div class="modal modal-blur fade" id="modal-valdiasilaporansupplier" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Validasi Laporan Supplier</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body" id="validasiformlaporansupplier">
...
<script>
    $(function(){
        ...
        $(".validasi_laporan_supplier").click(function(){
            var id = $(this).attr('id');
            $.ajax({
                type:'POST',
                url:'/owner/laporan/supplier/validasi_laporan_supplier',
                cache:false,
                data:{
                    _token : "{{ csrf_token() }}",
                    id : id
                ...
                success:function(respond){
                    $("#validasiformlaporansupplier").html(respond);
                }
            });
            $("#modal-valdiasilaporansupplier").modal("show");
        });


        $(".batalkan_validasi_laporan_supplier").click(function(e){
