                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="btn-group">
                                                                    @if ($d->status_data_koperasi == 0)
                                                                        <a href="#"
                                                                            class="validasi_data_koperasi btn btn-info btn-sm"
                                                                    ...
                                                                    @else
                                                                        <form
                                                                            action="/owner/data_koperasi/{{ $d->id_data_koperasi }}/batalkan_validasi_data_koperasi"
                                                                            style="margin-left: 5px;" method="POST">
                                                                            @csrf
                                                                            <a
                                                                                class="btn btn-sm bg-danger batalkan_validasi_data_koperasi">
                                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                                    height="24" viewBox="0 0 24 24" fill="none"
                                                                                    stroke="currentColor" stroke-width="2"
                                                                                    stroke-linecap="round" stroke-linejoin="round"
