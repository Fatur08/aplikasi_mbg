    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="" id="tanggal_operasional_dapur" name="tanggal_operasional_dapur" class="form-control" placeholder="Masukkan Tanggal" autocomplete="off">
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="" id="menu_operasional_dapur" name="menu_operasional_dapur" class="form-control" placeholder="Masukkan Menu" autocomplete="off">
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <textarea id="kendala_operasional_dapur" name="kendala_operasional_dapur" class="form-control" rows="1" placeholder="Tuliskan kendalanya di sini..."></textarea>
            </div>
        </div>
    </div>
    <div class="row">
