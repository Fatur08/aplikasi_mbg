                ...
                <div class="col-lg">
                    <div class="container-tight">
                        <div class="card card-md">
                            <div class="card-body">
                                <div class="section">
                                    <img src="{{ asset('assets/img/owner/login/loginowner.png') }}"
                                        alt="Sistem Admin Program MBG" class="form-image">
                                </div>
                                <h2 class="fs-1 fw-bolder text-center mb-0">Login Owner</h2>
                                <p class="fs-4 text-secondary text-center">Sistem Program MBG <br> Kabupaten Lampung
                                    Timur</p>
                                ...
                                <a href="{{ url('/') }}" class="btn btn-primary rounded-2 w-100 fw-bold"
                                    style="margin-top: 10px;">Kembali ke Halaman Utama</a>
                            </div>
                        </div>
                    </div>
                </div>
