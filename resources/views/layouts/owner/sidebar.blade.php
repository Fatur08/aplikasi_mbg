  ...
  <div class="container-fluid">
    ...
    <h1 class="navbar-brand">
      <a href="/owner/dashboardowner">
        <img src="../../assets/img/logo_SPPG_lampung_timur.png" alt="lamtim" class="navbar-brand-image"
    ...
    <div class="collapse navbar-collapse" id="sidebar-menu">
      <ul class="navbar-nav pt-lg-3">
        ...
        <!--<li class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
              <a class="nav-link" href="/owner/data_staff/maker" style="margin-left: 26px;">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
              ...
              <a class="nav-link" href="/owner/data_staff/kepala_dapur" style="margin-left: 26px;">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
              ...
              <a class="nav-link" href="/owner/data_staff/distributor" style="margin-left: 26px;">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
              ...
              <a class="nav-link" href="/owner/data_staff/data_pekerja" style="margin-left: 26px;">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu">
            ...
            <a class="nav-link" href="/owner/laporan/supplier" style="margin-left: 26px;">
              <span class="nav-link-icon d-md-none d-lg-inline-block">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu">
            ...
            <a class="nav-link" href="/owner/laporan/dapur" style="margin-left: 26px;">
              <span class="nav-link-icon d-md-none d-lg-inline-block">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
        ...
        @if($owner && $owner->id == 2)
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
              <a class="nav-link" href="/owner/operasional/informasi_operasional" style="margin-left: 26px;">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
              ...
              <a class="nav-link" href="/owner/operasional/laporan_operasional" style="margin-left: 26px;">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
      ...
      <a class="btn btn-danger" href="/proseslogoutowner" onclick="showSuccess()"
        style="margin-left: 10px; margin-bottom: 20px;">Log out</a>
    </div>
  </div>
</aside>