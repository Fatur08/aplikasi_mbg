                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="row mt-2">
                                <div class="col-12">
                                    <form action="/maker/data_supplier/supplier" method="GET">
                                        <div class="row">
                                            <div class="col-4">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align:center">
                                                            <div class="btn-group">
                                                                ...
                                                                <form action="/maker/data_supplier/supplier/{{ $d->id_supplier }}/delete_supplier" style="margin-left: 5px;" method="POST">
                                                                    @csrf
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/maker/data_supplier/supplier/store_supplier" method="POST" id="frmInfrmsSpplr" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-12">
...
<script>
    $(function(){
        ...
        $(".edit_supplier").click(function(){
            ...
            $.ajax({
                type:'POST',
                url:'/maker/data_supplier/supplier/edit_supplier',
                cache:false,
                data:{
                    _token : "{{ csrf_token() }}",
                    id : id
