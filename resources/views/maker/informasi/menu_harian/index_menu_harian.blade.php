            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                <form action="/maker/informasi/menu_harian" method="GET">
                                    <div class="row">
                                        <div class="col-5">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="btn-group">
                                                                    ...
                                                                    <form action="/maker/laporan/distribusi//delete_laporan_distribusi" style="margin-left: 5px;" method="POST">
                                                                        @csrf
...
<script>
    $(function(){
        ...
        $(".bahan_terpakai").click(function(){
            ...
            $.ajax({
                type:'POST',
                url:'/maker/laporan/harian_dapur/bahan_terpakai',
                cache:false,
                data:{
                    _token : "{{ csrf_token() }}",
                    id : id
        ...
        $(".bahan_sisa").click(function(){
            ...
            $.ajax({
                type:'POST',
                url:'/maker/laporan/harian_dapur/bahan_sisa',
                cache:false,
                data:{
                    _token : "{{ csrf_token() }}",
                    id : id
        ...
        $(".kendala_harian_dapur").click(function(){
            ...
            $.ajax({
                type:'POST',
                url:'/maker/laporan/harian_dapur/kendala_harian_dapur',
                cache:false,
                data:{
                    _token : "{{ csrf_token() }}",
                    tanggal : tanggal
