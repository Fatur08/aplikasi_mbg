                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mt-2">
                                <div class="col-12">
                                    <form action="/maker/stok_keluar" method="GET">
                                                        ...
                                                        <table class="table custom-table">
                                                            ...
                                                            <tbody>
                                                                @foreach($items as $key => $data)
                                                                    <tr @if($data->sisa_stok == 0 || $data->sisa_perbahan <= 0)
                                                                    class="table-warning" @endif>
                                                                        <td>{{ $key + 1 }}</td>
                                                                        <td>{{ \Carbon\Carbon::parse($data->tanggal_keluar)->translatedFormat('d F Y') }}
                                                                        </td>
                                                                        ...
                                                                        <td>
                                                                            <div class="btn-group">
                                                                                <form
                                                                                    action="/maker/stok_keluar/{{ $data->id_stok_keluar }}/delete_stok_keluar"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/maker/stok_keluar/store_stok_keluar" method="POST" id="frmStkMsk"
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" value="" id="tanggal_keluar" name="tanggal_keluar"
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="number" value="" id="jumlah_keluar" class="form-control"
                                        name="jumlah_keluar" placeholder="Masukkan Jumlah Stok Keluar">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="input-icon mb-3">
                                    ...
                                    <textarea id="keterangan_stok_keluar" name="keterangan_stok_keluar" class="form-control"
    ...
    <script>
        $(function () {
            ...
            $(".edit_stok_keluar").click(function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: '/maker/stok_keluar/edit_stok_keluar',
                    cache: false,
                    data: {
                        _token: "{{ csrf_token() }}",
                        id: id
