            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mt-2">
                            <div class="col-12">
                                <form action="/admin/stok_keluar" method="GET">
                                    <div class="row">
                                        <div class="col-md-4">
                                                        ...
                                                        <tbody>
                                                            @foreach($items as $key => $data)
                                                                <tr @if($data->sisa_stok == 0 || $data->sisa_perbahan <= 0) class="table-warning" @endif>
                                                                    ...
                                                                    <td>
                                                                        <div class="btn-group">
                                                                            <form action="/admin/stok_keluar/{{ $data->id_stok_keluar }}/delete_stok_keluar" style="margin-left: 5px;" method="POST">
                                                                                @csrf
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/admin/stok_keluar/store_stok_keluar" method="POST" id="frmStkMsk" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-12">
...
<script>
    $(function(){
        ...
        $(".edit_stok_keluar").click(function(){
            ...
            $.ajax({
                type:'POST',
                url:'/admin/stok_keluar/edit_stok_keluar',
                cache:false,
                data:{
                    _token : "{{ csrf_token() }}",
                    id : id
