                                                        ...
                                                        <tbody>
                                                            @foreach($items as $key => $data)
                                                                <tr @if($data->sisa_stok == 0 || $data->sisa_perbahan <= 0) class="table-warning" @endif>
                                                                    ...
                                                                    <td>
                                                                        <div class="btn-group">
                                                                            <form action="/maker/stok_keluar/{{ $data->id_stok_keluar }}/delete_stok_keluar" style="margin-left: 5px;" method="POST">
                                                                                @csrf
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/maker/stok_keluar/store_stok_keluar" method="POST" id="frmStkMsk" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-12">
