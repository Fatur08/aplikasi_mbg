            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mt-2">
                            <div class="col-12">
                                <form action="/maker/data_induk/kepala_dapur" method="GET">
                                    <div class="row">
                                        <div class="col-6">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/maker/data_induk/kepala_dapur/store_kepala_dapur" method="POST" id="frmKplDpr" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-12">
...
<script>
    $(function(){
        ...
        $(".edit_kepala_dapur").click(function(){
            ...
            $.ajax({
                type:'POST',
                url:'/maker/data_induk/kepala_dapur/edit_kepala_dapur',
                cache:false,
                data:{
                    _token : "{{ csrf_token() }}",
                    id : id
