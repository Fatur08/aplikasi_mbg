            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mt-2">
                            <form action="/maker/data_staff/driver" method="GET">
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-4">
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                <a href="#" class="btn btn-success w-100" id="TambahDriver" >
...
<!-- TAMBAH DRIVER -->
<div class="modal modal-blur fade" id="modal-inputdriver" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/maker/data_staff/driver/store_driver" method="POST" id="FormTambahDriver" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-12">
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" value="" id="nama_driver" class="form-control" name="nama_driver" placeholder="Masukkan Nama Lengkap">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row mt-3 mb-3">
                        <div class="col-12">
                            <div class="input-icon">
                                ...
                                <input type="text" value="" id="alamat_driver" class="form-control" name="alamat_driver" placeholder="Masukkan Alamat">
                              </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row mt-3 mb-3">
                        <div class="col-6">
                            <input type="file" id="foto_driver" name="foto_driver" class="form-control">
                        </div>
