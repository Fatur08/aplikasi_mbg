                                    ...
                                    <div class="row mt-2">
                                        <div class="col-12">
                                            <div class="row g-2 align-items-end">
                                                <div class="col-md-6">
                                                    <div class="input-icon">
                                                        <select name="pilih_supplier_koperasi" id="pilih_supplier_koperasi"
                                                            class="form-select">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table custom-table">
                                                    <thead class="table-primary text-center">
                                                        ...
                                                        <tr>
                                                            <th style="text-align: center; vertical-align: middle;">Koperasi
                                                            </th>
                                                            <th style="text-align: center; vertical-align: middle;">Supplier
                                                            </th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        @foreach ($data as $i => $d)
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    <a href="#"
                                                                        class="bukti_laporan_keuangan btn btn-info btn-sm"
                                                                        data-id="{{ $d->id_laporan_keuangan }}">
                                                                        👁 Lihat
                                                                    </a>
                                                                </td>
