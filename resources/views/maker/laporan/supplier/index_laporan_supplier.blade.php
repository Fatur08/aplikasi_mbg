                                ...
                                <div class="row mt-2">
                                    <div class="col-12">
                                        <div class="row g-2 align-items-end">
                                            ...
                                            <!--<div class="col-md-3">
                                                <div class="form-group">
                                                    <a href="#" class="btn btn-success w-100" id="cetak_laporan_supplier" >
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" value="" id="barang_laporan_supplier" name="barang_laporan_supplier" class="form-control"  placeholder="Masukkan Nama Barang">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="input-icon mb-3">
                                ...
                                <input type="number" value="" id="jumlah_barang_laporan_supplier" name="jumlah_barang_laporan_supplier" class="form-control" placeholder="Masukkan Jumlah Barang">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="input-icon mb-3">
                                ...
                                <input type="number" value="" id="harga_barang_laporan_supplier" name="harga_barang_laporan_supplier" class="form-control" placeholder="Masukkan Total Harga Barang">
                            </div>
                        </div>
                    </div>
                    <div class="row mt-2">
