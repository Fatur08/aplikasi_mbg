                            ...
                            <div class="row mt-2">
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <a href="#" class="tambah_operasional_dapur btn btn-secondary w-100"
                                                    id="tambah_operasional_dapur">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                        viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                        class="icon icon-tabler icons-tabler-outline icon-tabler-plus">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/maker/laporan/dapur/store_pm_dapur" method="POST" id="FormInputPenerimaManfaat"
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" value="" id="nama_sekolah_atau_b3" class="form-control"
                                        name="nama_sekolah_atau_b3" placeholder="Masukkan Nama Sekolah / B3">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="number" value="" id="jumlah_pm" class="form-control" name="jumlah_pm"
