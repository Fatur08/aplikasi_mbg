                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="row mt-2">
                                    <div class="col-12">
                                        <form action="/maker/laporan/stok" method="GET" id="FormLaporanStokHarian">
                                                        ...
                                                        @forelse($data_laporan as $no => $row)
                                                            <tr>
                                                                ...
                                                                <td style="text-align:left;">
                                                                    {{ number_format($row['stok_awal'], 0, ',', '.') }}</td>
                                                                <td style="text-align:left;">
                                                                    {{ number_format($row['masuk'], 0, ',', '.') }}</td>
                                                                <td style="text-align:left;">
                                                                    {{ number_format($row['keluar'], 0, ',', '.') }}</td>
