...
{
    // BAGIAN OWNER
    public function index_owner_data_staff_aslap(Request $request)
    {
        ...
        return view('owner.data_staff.aslap.index_aslap', compact('aslap', 'dapurList', 'namaDapur'));
    }




    public function validasi_owner_data_staff_aslap(Request $request)
    {
        $id = $request->id;
        $aslap = DB::table('aslap')->get();
        $data = DB::table('aslap')->where('id_aslap', $id)->first();
        return view('owner.data_staff.aslap.validasi_aslap',compact('aslap','data'));
    }



    public function update_owner_validasi_aslap($id, Request $request)
    {
        try {
    ...
    public function batalkan_owner_validasi_aslap($id, Request $request)
    {
        $update = DB::table('aslap')
            ->where('id_aslap',$id)
            ->update([
