...
Route::middleware(['auth:owner'])->group(function () {
    ...
    Route::post('/owner/operasional/laporan_operasional/validasi_laporan_operasional', [OperasionalController::class, 'validasi_laporan_operasional']);
    Route::post('/owner/operasional/laporan_operasional/{id}/update_validasi_laporan_operasional', [OperasionalController::class, 'update_validasi_laporan_operasional']);
    Route::post('/owner/operasional/laporan_operasional/{id}/batalkan_validasi_laporan_operasional', [OperasionalController::class, 'batalkan_validasi_laporan_operasional']);
});
...
Route::middleware(['auth:maker'])->group(function () {
    ...
    Route::get('/maker/stok_masuk/get_bahan_koperasi', [StokMasukController::class, 'getBahanKoperasi']);
